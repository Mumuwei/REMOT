...
class BaseOptions():
    ...
    def initialize(self):   
        self.parser.add_argument('--checkpoints_dir', type=str, default='./check_points/test2', help='models are saved here')
        ...
        self.parser.add_argument('--n_downsample_cloth', type=int, default=3, help='number of downsampling layers in warper')        
        ...
        # miscellaneous 
        self.parser.add_argument('--load_pretrain_1', type=str, default='', help='if specified, load the pretrained model')
        self.parser.add_argument('--load_pretrain_2', type=str, default='', help='if specified, load the pretrained model')      
        self.parser.add_argument('--load_pretrain_3', type=str, default='', help='if specified, load the pretrained model')  
