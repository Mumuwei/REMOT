...
class Test1Dataset(BaseDataset):
    def initialize(self, opt):
        ...
        #这个函数在basedataset类中
        self.init_frame_idx_full(self.sparsing_paths)
    ...
    def __getitem__(self, index):
        ...
        #生成0-13的数字
        frame_range = list(range(n_frames_total+2)) if (self.opt.isTrain or self.TPose is None) else [self.opt.n_frames_G-1]
        #print(frame_range)
        ...
        #print("sparsing_path",sparsing_path)
