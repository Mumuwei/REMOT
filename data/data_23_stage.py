...
class Test23Dataset(BaseDataset):
    def initialize(self, opt):
        ...
        self.dir_sparsing = os.path.join(opt.dataroot, opt.phase + '_parsing/source')#这个应该使用stage1的输出,不用的话就是在测试stage23
...
#             print("xxS",np.max(SParsing_np))
#             print("yyS",np.min(SParsing_np))
            ...
            SParsing_new_np[(SParsing_np == 9)| (SParsing_np == 10)] = 5#鞋子sing_new_np = np.zeros_like(SParsing_np)
