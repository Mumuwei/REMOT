...
class TrainOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('--use_fusion', action='store_true', help='use fusion in stage3')
        
        
        
        self.parser.add_argument('--which_epoch_1', type=str, default='latest', help='which epoch to load? set to latest to use latest cached model')
        self.parser.add_argument('--which_epoch_2', type=str, default='latest', help='which epoch to load? set to latest to use latest cached model')
        self.parser.add_argument('--which_epoch_3', type=str, default='latest', help='which epoch to load? set to latest to use latest cached model')
