...
--checkpoints_dir ./check_points/stage3_rm_fusion \
...
--load_pretrain_3 /home/wujinlin5/yqw_home/Motion_Transfer/C2F-FWN-new/check_points/test3/composer_256p --which_epoch_3 latest
